...
Santa Barbara is a vibrant historical city, teeming with arts and cultural experiences, culinary adventures, stunning landscapes, beautiful parks, and outdoor activities. Check out this [Unofficial Guide to Housing](https://emlab-nextcloud.grit.ucsb.edu/index.php/s/4yctTaDro3Bsewj) to learn more about the neighborhoods in Santa Barbara.

As a note, Santa Barbara does have high housing costs and demand in comparison to most of the United States, and can be a challenging destination to relocate to. You may find the following resources helpful, but we also encourage you to reach out to our Program Manager (eoreilly@ucsb.edu) if you need additional insight on short- or long-term housing.  
...
For Bren Hall building and shower keys, and to make copies/scan/fax, contact info@bren.ucsb.edu. For MSI keys, contact msi-building@ucsb.edu. 
...
emLab has a series of listservs for calendar invites and contacting subsets of our organization:
- emlab-pi@googlegroups.com
- emlab-staff@googlegroups.com
- emlab-postdoc@googlegroups.com
- emlab-ops@googlegroups.com
- emlab-student@googlegroups.com
- emlab-visitors@googlegroups.com
- emlab-community@googlegroups.com
...
Key acquisition methods depend on which building your office is located in. Erin will initiate the first email with the correct contact.

Here’s a [list of the emLab team](https://docs.google.com/spreadsheets/d/1hjFkcU68e7AMs-ueEYR82idqi3-dMJk-p1VRd5_YZV8/edit?usp=sharing). 
...
- Meeting with Erin, emLab’s Program Manager: an overview of emLab’s platforms, resources, and workflow
