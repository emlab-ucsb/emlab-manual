...
- If needed, complete initial information gathering to understand the current landscape and scientific understanding of the research topic. This may include quickly reviewing the most relevant or recent literature, engaging with emLab PIs/research staff with relevant expertise, conducting a search for related research efforts, and learning about the policy/market context of the proposed study.
...
- When relevant, use exploratory framing and explicitly incorporate scoping activities in the SOW. For example, if the appropriate approach is unknown, use Phase 1 of the study to review method options.
- Plan for flexibility and build in slack.