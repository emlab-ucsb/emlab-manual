...
There are two options for catering meals on campus:
1. Campus catering
...
- Food being delivered to campus is less than $150 
- Pizza delivery
...
Entertainment reimbursements are centralized through [Concur](http://www.concursolutions.com/), where they are referred to as expense reports. 

If you have not done so already, make sure to add Kimberly Taylor and Celeste Francisco (for MSI reimbursements) or Jewels Bolden (for Bren reimbursements) to your profile as delegate preparers. When assigning them as delegates, give them the following permissions: Can Prepare, Can Submit Requests, Can View Receipts, and Receive Emails. Here’s a short [video](https://ucsb.service-now.com/kb?id=kb_article_view&sys_kb_id=a8df60ba1b348554e9250f22604bcba3) on how to set up delegates in your profile.
...
*Note: this section was written in February 2022 at the launch of the campus adoption of Concur. We will update these instructions as we learn more about the process.*
...
1. **Travel Advances:** if you prefer to make your own reservations, might have to cancel/change your tickets, or plan to stay in non-traditional accommodations (e.g., AirBnb) you may have to pay for some of your travel expenses out of pocket before you go. Though you can’t submit a complete travel reimbursement form until after you return from your trip, you can get a partial reimbursement for expenses you cover prior to traveling by applying for a travel advance. 
  ...
  - Once a full draft of your request is ready, email Donna at MSI (donna.dobis@ucsb.edu) so she can review the request for compliance and completion. You submit the request after you get an ok from her. 
...
2. **Concur Travel** - What was previously Connexxus is now housed within Concur and can be used to book flights, rental cars, or hotels. These reservations are directly billed to a University account, so there is no out-of-pocket cost. To book through the Travel tab in Concur:
  - Submit a request in Concur for your trip that includes the flight/hotel information and the project to charge. Ping Donna Winckler that you have a request ready for review.
  - Once Donna has approved your request, book your flight/hotel through the "Travel" tab in Concur. You charge this to the University credit card, not your own.
...
4. Save and close out. DO NOT submit the report yet. Notify donna.dobis@ucsb.edu or travel@bren.ucsb.edu that you have a draft expense report ready to review for compliance and completion. 
5. Submit a report ONLY after the Bren or MSI purchasing team notifies you to do so.

**Domestic travel**

When you return from domestic travel, you will need to fill out an expense report on Concur to be reimbursed for any expenses you incurred and paid for out-of-pocket while traveling. To be reimbursed for U.S. travel, you will need to submit an expense form with itemized receipts for all of your purchases – you cannot claim per diem for a domestic trip less than 30 days.
...
When you return from traveling outside of the country, you will need to fill out an expense report on Concur to be reimbursed for any expenses you incurred while traveling. 
