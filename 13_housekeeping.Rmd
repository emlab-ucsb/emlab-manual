...
UCSB holidays can be found on the academic calendar [here](https://registrar.sa.ucsb.edu/calendars/calendars-deadlines/academic-calendars/academic-calendar-menu). We automatically get these days off – you do not claim vacation hours for them. 
...
emLab MSI Suite (1304): add bren-sfg@ucsb.edu to any calendar invite to reserve the room. Add this same email address to your calendar to view availability. See the next section for information on the comouting set-up for this room.
...
Submit a [Bren Hall Room Request Form](https://bren.formstack.com/forms/bren_room_request) if you would like to reserve the Dean’s Conference Room (BH 2436), Bren 1414 (large lecture hall), or Bren 1424 (larger seminar room/classroom).
...
**Important rules when using booking.bren.ucsb.edu:**
 
- All new meetings must be created in booking.bren.ucsb.edu
- All edits/modifications must be made in booking.bren.ucsb.edu
- Do NOT attach a Bren room/resource to an existing event created on your personal Google Calendar
- Do NOT edit the event in your personal Google Calendar after booking.bren.ucsb.edu creates it
- If the meeting includes a Bren room/resource, the event must be created and managed in booking.bren.ucsb.edu

### Computing set-up for MSI 1304
...
- **Make sure that bren-sfg@ucsb.edu is invited to the meeting.** This is linked to the MSI 1304 room calendar. 
- **Attach any relevant documents to the calendar invite.** Alternatively, ensure everything is in Shared Drive. The emLab gmail has access to our Shared Drive.

**Turning the screen and computer on**

- Turn the iMac under the TV and TV screen on if needed - use remote or power button to turn the screen on; turn computer on using power button on apple iMac. - Log-into the iMac. The log-in is labeled on the bottom right corner of the screen with the following information:
  - Username: sfg-totoaba
  - Password: totoaba

**Joining Zoom**

- Open Google Chrome – the emLab account should be signed in. This account is linked to the MSI 1304 calendar, so when opening Google Calendar you should be able to see your meeting invite + Zoom link. The Owl is automatically set-up for any Zoom meeting originating on the iMac.
  - If the emLab account isn’t logged in, reach out to Erin first and then if needed, log into Chrome using your credentials and join via your calendar

**Presenting slides**

- **If your slides are in emLab shared drive or added previously to the calendar invite:** You can navigate to them using Chrome and pull them up. 
- **If you have a USB drive**, plug it into the back of the iMac. It should pop up for you to pull any relevant files.  
- **If you have a laptop and are presenting on Zoom:** If you need to share a presentation and you have your laptop, follow the steps above and join the Zoom call from your laptop without connecting to audio. You will be able to share your screen for all participants to see. 
- **If you have a laptop and no remote participants:** You can unplug the HDMI cord from the dongle connected to the iMac and plug the HDMI cord into your laptop. This will connect you to the TV. 
  - There is a USB-C dongle if your laptop requires one for connection. 
  - PLEASE plug the HDMI cord back into the iMac dongle once the meeting is over.
...
Note: this was updated November 2024. [This website](https://bfs.ucsb.edu/travel_entertainment/entertainment-reimbursement) will have the most up-to-date information on meal rates. 
...
Per UC policy, when traveling in the U.S. you can only be reimbursed up to $333/ night for lodging, and up to $92/day for meals and incidentals. If you exceed either maximum, know that you must cover the rest with your own funds. If you can’t find a hotel below $333/night, you will need to provide evidence of this (i.e. you must show proof of rates from other hotels in the nearby area that are higher than yours) to corroborate your claim that you got the cheapest available rate. Only then can you be reimbursed the full amount. There are no exceptions for exceeding the daily maximum for food.
...
- **Travel Advances:** if you prefer to make your own reservations, might have to cancel/change your tickets, or plan to stay in non-traditional accommodations (e.g., AirBnb) you may have to pay for some of your travel expenses out of pocket before you go. Though you can’t submit a complete travel reimbursement form until after you return from your trip, you can get a partial reimbursement for expenses you cover prior to traveling by applying for a travel advance. 
  - Travel advance requests should be submitted at least 15 business days before travel commences.
  - You can request an advance for any anticipated trip expenses but always try to underestimate so you are sure you will spend the entire advance, otherwise you will need to write a repayment check to the UC Regents when you return. When you return you will still need to complete a final travel expense report to clear the advance and be reimbursed for any additional trip expenses incurred.
  ...
  - Fill out all of the information for your trip (name, dates, project code to charge, etc.). Once the general information has been submitted, you will be taken to a screen that allows you to insert line items for expenses you are requesting a travel advance for (e.g. conference registration, flight). Once you insert the information, click on the line item(s) and then under “Request Details” click “Add Cash Advance.” View this [video](https://ucsb.service-now.com/kb?sys_kb_id=0d41a7dd1b3f745047e8ed34604bcb57&id=kb_article_view&sysparm_rank=2&sysparm_tsqueryId=5a6646a81bbdc51078889683b24bcb79) for visual instructions. 
  - Once a full draft of your request is ready, email MSI Travel (travel@msi.ucsb.edu) so they can review the request for compliance and completion. You submit the request after you get an ok from them. 
  ...
  - Note: you can only have **one travel advance at a time**. You cannot have another travel advance until that trip concludes and is cleared in Concur.
  
- **Concur Travel**: What was previously Connexxus is now housed within Concur and can be used to book flights or rental cars. These reservations are directly billed to a University account, so there is no out-of-pocket cost. To book through the Travel tab in Concur:
  - Submit a request in Concur for your trip that includes the flight/car information and the project to charge. Ping MSI Travel that you have a request ready for review.
  - Once MSI Travel has approved your request, book your flight/car through the "Travel" tab in Concur. You charge this to the University credit card, not your own.
...
4. Once the expense report is complete, save and close out. DO NOT submit the report yet. Notify travel@msi.ucsb.edu or travel@bren.ucsb.edu that you have a draft expense report ready to review for compliance and completion. 
...
- Kim Taylor (MSI; travel reimbursements) – kim.taylor@ucsb.edu or travel@msi.ucsb.edu
...
- Charlyna DeFeyter (Bren; travel) - travel@bren.ucsb.edu
...
2. Fill out the fields listed on the report (e.g. event name, date, business purpose, etc.). 
    ...
    - When filling out the account information, be sure to select “Either” for the filter option so you see the correct options.
    - CCOA account information: you will first select the type of CCOA, which will be either GL strings (for gift accounts) or Project strings (for grants)
        - If you are entering a GL string: enter the FRU, Fund, and Purpose boxes with the relevant codes. You may also have to enter an Activity number for some accounts, like Arnhold. Here Fund is the unique identifier.
        - If you are entering a Project string: enter the Project number in the FRU/Project box.
...
5. If your receipt contains both food and alcohol, upload the receipt as a single line item. Then itemize the receipt between food and alcohol totals. For alcohol, you can also change the account code if you are not yet charging the meal to a discretionary account. 
6. Save and close out. DO NOT submit the report yet. Notify purchasing@msi.ucsb.edu or purchasing@bren.ucsb.edu that you have a draft expense report ready to review for compliance and completion. 
7. Submit a report ONLY after the Bren or MSI purchasing team notifies you to do so. 
...
4. Save and close out. DO NOT submit the report yet. Notify travel@msi.ucsb.edu or travel@bren.ucsb.edu that you have a draft expense report ready to review for compliance and completion. 
5. Submit a report ONLY after the MSI or Bren purchasing team notifies you to do so.
...
- For domestic travel, you can fill out a [meal log](https://msi.ucsb.edu/sites/default/files/docs/Meal%20Log.pdf) instead of uploading each meal receipt separately, as long as the meal is under $75. If you go the meal log route:
