...
1. Fill out the GRIT compute access request form (CARF): [](https://forms.gle/kqzttgMAjzt867FZA)
...
3. Create your GRIT access credentials at the following link: [](https://dc1.grit.ucsb.edu/). The username and password you use here will be the same username and password for accessing the Nextcloud data directories and emLab servers.
...
2. Create your GRIT access credentials at the following link: [](https://dc1.grit.ucsb.edu/). The username and password you use here will be the same username and password for accessing the Nextcloud data directories and emLab servers.
...
**Step2:** After completing the setup process, you can always add more directories to sync later on, or can always remove synced directories. To add new directories you want to sync: in the Nextcloud app, simply right-click on the directory you want to sync locally, click “Availability”, and click “Make always available locally”. To remove synced directories, you can instead click “Free up local space”.
