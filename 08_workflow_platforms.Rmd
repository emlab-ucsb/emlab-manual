...
Windows: The Windows version of the Nextcloud desktop app is the easiest to configure for virtual files, since virtual files are enabled by default. Simply ensure that the virtual file option is selection ("Use virtual files instead of downloading content immediately"), and then click "Connect."
